...
void PrimitivesRenderer::render(PrimitiveType type, std::span<glm::vec3> positions_scales, const FrameInfo &frame)
{
    ...
    for (auto &&pos : positions_scales)
    {
        m_push.position = {pos.x, pos.y};
        m_push.scale = pos.z;
