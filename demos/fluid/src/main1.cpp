...
static int particle_count = 1000;
...
static PushConstants push{particle_count, 0.1f, 100.0f, 1.0f / 900.0f};
...
int main1()
{
    ...
    while (engine.running())
    {
        ...
        /*    ParticleGrid::particle_scale * ving::Engine::initial_window_height,*/
        /*};*/
        /*std::vector<uint32_t> indices = grid.get_cell_particle_indices(part);*/
        /*for (auto &&i : indices)*/
        /*{*/
        /*    primitive_parameters[i].color = {1.0f, 0.0f, 1.0f};*/
        /*}*/

        // Render smoothing radius at cursor
        /*primitive_parameters.push_back({{part.position.x * ving::Engine::initial_window_width,*/
        /*                                 part.position.y * ving::Engine::initial_window_height},*/
        /*                                push.smoothing_radius * ving::Engine::initial_window_height,*/
        /*                                glm::vec3{1.0f}});*/
